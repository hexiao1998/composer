   ...
   <div class="mws-panel-body no-padding"> 
    <div id="DataTables_Table_1_wrapper" class="dataTables_wrapper" role="grid">
     ...
     <div class="dataTables_filter" id="DataTables_Table_1_filter">
      <label>用户名<input type="text" name="keyword" aria-controls="DataTables_Table_1" value="{{$request['keyword'] or ''}}"/>邮箱<input type="text" name="keywords" aria-controls="DataTables_Table_1" value="{{$request['keywords'] or ''}}"/></label>
       ...
       <tr class="odd"> 
        ...
        <td>
            <form action="/adminusers/{{$row->id}}" method="post">
                ...
                <a href="/adminusers/{{$row->id}}/edit" class="btn btn-danger"><i class="icon-pencil"></i></a>
        </td>
       </tr>
       @endforeach
      </tbody>
